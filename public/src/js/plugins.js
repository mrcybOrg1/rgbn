...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        ...
        m.getTweensOf = function(t, e) {
            ...
            r = (s = i.getTweensOf(t)).length; --r > -1; )
    ...
    _ = function(t, e, i, a, o) {
        var l, _, u, f, c, p, d, m, g, y, v, T, x, b = t.length - 1, w = 0, P = t[0].a;
        for (l = 0; b > l; l++)
            c = t[w],
            _ = c.a,
            u = c.d,
            ...
            o ? (v = s[l],
            T = r[l],
            x = (T + v) * e * .25 / (a ? .5 : n[l] || .5),
            p = u - (u - _) * (a ? .5 * e : 0 !== v ? x / v : 0),
            d = u + (f - u) * (a ? .5 * e : 0 !== T ? x / T : 0),
            m = u - (p + ((d - p) * (3 * v / (v + T) + .5) / 4 || 0))) : (p = u - (u - _) * e * .5,
            d = u + (f - u) * e * .5,
            m = u - (p + d) / 2),
            p += m,
            d += m,
    ...
    u = function(t, e, i, n) {
        ...
        if (n)
            for (t = [n].concat(t),
            o = t.length; --o > -1; )
                "string" == typeof (f = t[o][e]) && "=" === f.charAt(1) && (t[o][e] = n[e] + Number(f.charAt(0) + f.substr(2)));
        if (0 > (a = t.length - 2))
    ...
    f = function(t, e, i, o, l, h) {
        var f, c, p, d, m, g, y, v, T = {}, x = [], b = h || t[0];
        ...
        for (s.length = r.length = n.length = 0,
        f = x.length; --f > -1; )
            c = x[f],
            a[c] = -1 !== l.indexOf("," + c + ","),
            T[c] = u(t, c, a[c], h);
    ...
    p = _gsScope._gsDefine.plugin({
        ...
        init: function(t, e, i) {
            ...
            var s, r, n, a, o, h = e.values || [], _ = {}, u = h[0], p = e.autoRotate || i.vars.orientToBezier;
            ...
            for (n = this._props.length; --n > -1; )
                ...
                _[s] = r ? t[s.indexOf("set") || "function" != typeof t["get" + s.substr(3)] ? s : "get" + s.substr(3)]() : parseFloat(t[s]),
                o || _[s] !== h[0][s] && (o = _);
            if (this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? f(h, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, o) : function(t, e, i) {
                var s, r, n, a, o, h, _, u, f, c, p, d = {}, m = "cubic" === (e = e || "soft") ? 3 : 2, g = "soft" === e, y = [];
                if (g && i && (t = [i].concat(t)),
                null == t || t.length < m + 1)
                ...
                for (h = y.length; --h > -1; ) {
                    ...
                    _ = 0; u > _; _ += m)
                        ...
                        n = o[_ + 2],
                        a = 2 === m ? 0 : o[_ + 3],
                        o[c++] = p = 3 === m ? new l(s,r,n,a) : new l(s,(2 * r + s) / 3,(2 * r + n) / 3,n);
                    o.length = c
                }
                return d
            }(h, e.type, _),
            ...
            this._timeRes) {
                var d = function(t, e) {
                    var i, s, r, n, a = [], o = [], l = 0, h = 0, _ = (e = e >> 0 || 6) - 1, u = [], f = [];
                    for (i in t)
                        c(t[i], a, e);
                    for (r = a.length,
                    s = 0; r > s; s++)
        ...
        set: function(t) {
            var e, s, r, n, a, o, l, h, _, u, f = this._segCount, c = this._func, p = this._target, d = t !== this._startRatio;
            if (this._timeRes) {
                if (_ = this._lengths,
                u = this._curSeg,
                t *= this._length,
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        var _, u, f, c, p, d, m, g, y, v, T = /(?:\-|\.|\b)(\d|\.|e\-)+/g, x = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, b = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, w = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, P = /(?:\d|\-|\+|=|#|\.)*/g, O = /opacity *= *([^)]*)/i, S = /opacity:([^;]*)/i, k = /alpha\(opacity *=.+?\)/i, R = /^(rgb|hsl)/, A = /([A-Z])/g, C = /-([a-z])/gi, D = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, M = function(t, e) {
            return e.toUpperCase()
        }, F = /(?:Left|Right|Width)/i, z = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, E = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, I = /,(?=[^\)]*(?:\(|$))/gi, X = /[\s,\(]/i, N = Math.PI / 180, L = 180 / Math.PI, B = {}, Y = {
            style: {}
        }, j = _gsScope.document || {
        ...
        }, V = U("div"), q = U("img"), W = a._internals = {
            _specialProps: l
        }, G = (_gsScope.navigator || {}).userAgent || "", Z = (y = G.indexOf("Android"),
        v = U("a"),
        f = -1 !== G.indexOf("Safari") && -1 === G.indexOf("Chrome") && (-1 === y || parseFloat(G.substr(y + 8, 2)) > 3),
        ...
        !!v && (v.style.cssText = "top:1px;opacity:.55;",
        /^0.55/.test(v.style.opacity))), H = function(t) {
            ...
            s = 5; --s > -1 && void 0 === r[i[s] + t]; )
                ;
            return s >= 0 ? (Q = "-" + (K = 3 === s ? "ms" : i[s]).toLowerCase() + "-",
            K + t) : null
        }, tt = j.defaultView ? j.defaultView.getComputedStyle : function() {}
        , et = a.getStyle = function(t, e, i, s, r) {
            var n;
            return Z || "opacity" !== e ? (!s && t.style[e] ? n = t.style[e] : (i = i || tt(t)) ? n = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(A, "-$1").toLowerCase()) : t.currentStyle && (n = t.currentStyle[e]),
            null == r || n && "none" !== n && "auto" !== n && "auto auto" !== n ? n : r) : H(t)
        }
        , it = W.convertToPixels = function(t, i, s, r, n) {
            ...
            if ("auto" === r || !s)
                return 0;
            var o, l, h, _ = F.test(i), u = t, f = V.style, c = 0 > s, p = 1 === s;
            if (c && (s = -s),
            p && (s *= 100),
            "lineHeight" !== i || r)
                if ("%" === r && -1 !== i.indexOf("border"))
                    ...
                    if (f.cssText = "border:0 solid red;position:" + et(t, "position") + ";line-height:0;",
                    ...
                    u.removeChild(V),
                    _ && "%" === r && !1 !== a.cacheWidths && ((l = u._gsCache = u._gsCache || {}).time = h,
                    l.width = o / s * 100),
        ...
        , rt = function(t, e) {
            ...
            if (e = e || tt(t, null))
                if (i = e.length)
                    for (; --i > -1; )
                        r = e[i],
                        (-1 === r.indexOf("-transform") || Et === r) && (n[r.replace(C, M)] = e.getPropertyValue(r));
                else
                    for (i in e)
            ...
            for (a in i)
                "cssText" !== a && "length" !== a && isNaN(a) && (e[a] !== (n = i[a]) || r && r[a]) && -1 === a.indexOf("Origin") && ("number" == typeof n || "string" == typeof n) && (l[a] = "auto" !== n || "left" !== a && "top" !== a ? "" !== n && "auto" !== n && "none" !== n || "string" != typeof e[a] || "" === e[a].replace(w, "") ? n : 0 : st(t, a),
            ...
            n = t.split("_"),
            a = ((l = "=" === t.charAt(1)) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(n[0].substr(2)) : parseFloat(n[0])) * (-1 === t.indexOf("rad") ? 1 : L) - (l ? 0 : e),
            n.length && (s && (s[i] = e + a),
        ...
        var yt = function(t, e, i, s) {
            if (null == t)
                ...
                ;
            var r, n = e ? (t.match(gt) || [""])[0] : "", a = t.split(n).join("").match(b) || [], o = t.substr(0, t.indexOf(a[0])), l = ")" === t.charAt(t.length - 1) ? ")" : "", h = -1 !== t.indexOf(" ") ? " " : ",", _ = a.length, u = _ > 0 ? a[0].replace(T, "") : "";
        ...
        function(t, e, i, s, r) {
          ...
          , xt = (W._parseToProxy = function(t, e, i, s, r, n) {
            var a, o, l, h, _, u = s, f = {}, c = {}, p = i._transform, d = B;
        ...
        W.CSSPropTween = function(t, e, s, r, a, o, l, h, _, u, f) {
          ...
          , wt = a.parseComplex = function(t, e, i, s, r, n, o, l, h, u) {
            ...
            i = s[0],
            s = s[1]);
            var f, c, p, d, y, v, b, w, P, O, S, k, R, A = i.split(", ").join(",").split(" "), C = s.split(", ").join(",").split(" "), D = A.length, M = !1 !== _;
            for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (-1 !== (s + i).indexOf("rgb") || -1 !== (s + i).indexOf("hsl") ? (A = A.join(" ").replace(I, ", ").split(" "),
            C = C.join(" ").replace(I, ", ").split(" ")) : (A = A.join(" ").split(",").join(", ").split(" "),
            ...
            f = 0; D > f; f++)
                ...
                w = parseFloat(d),
                w || 0 === w)
                    o.appendXtra("", w, _t(y, w), y.replace(x, ""), M && -1 !== y.indexOf("px"), !0);
                else if (r && gt.test(d))
                    k = y.indexOf(")") + 1,
                    k = ")" + (k ? y.substr(k) : ""),
                    R = -1 !== y.indexOf("hsl") && Z,
                    ...
                    P && !Z && 0 === y[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent",
                    o.e = o.e.split(C[f]).join("transparent")) : (Z || (P = !1),
                    R ? o.appendXtra(O.substr(0, O.indexOf("hsl")) + (P ? "hsla(" : "hsl("), d[0], _t(y[0], d[0]), ",", !1, !0).appendXtra("", d[1], _t(y[1], d[1]), "%,", !1).appendXtra("", d[2], _t(y[2], d[2]), P ? "%," : "%" + k, !1) : o.appendXtra(O.substr(0, O.indexOf("rgb")) + (P ? "rgba(" : "rgb("), d[0], y[0] - d[0], ",", !0, !0).appendXtra("", d[1], y[1] - d[1], ",", !0).appendXtra("", d[2], y[2] - d[2], P ? "," : k, !0),
                    P && (d = d.length < 4 ? 1 : d[3],
                    o.appendXtra("", d, (y.length < 4 ? 1 : y[3]) - d, k, !1))),
                    gt.lastIndex = 0;
                else if (v = d.match(T)) {
                    ...
                    c = 0; c < v.length; c++)
                        S = v[c],
                        O = d.indexOf(S, p),
                        o.appendXtra(d.substr(p, O - p), Number(S), _t(b[c], S), "", M && "px" === d.substr(O + S.length, 2), 0 === c),
                        p = O + S.length;
                    o["xs" + o.l] += d.substr(p)
                } else
                    o["xs" + o.l] += o.l || o["xs" + o.l] ? " " + y : y;
        ...
        h.appendXtra = function(t, e, i, s, r, n) {
            ...
            a.rxp["xn" + o] = r,
            a["xn" + o] = e,
            a.plugin || (a.xfirst = new xt(a,"xn" + o,e,i,a.xfirst || a,0,a.n,r,a.pr),
            a.xfirst.xs0 = 0),
            a) : (a.data = {
                s: e + i
            },
            ...
            if (!l[t]) {
                ...
                St(t, {
                    parser: function(t, i, s, r, n, a, h) {
                        ...
                        l[s].parse(t, i, s, r, n, a, h)) : ($("Error: " + e + " js file not loaded."),
                        n)
                    }
                })
            }
        ...
        var Rt, At, Ct, Dt, Mt, Ft = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), zt = J("transform"), Et = Q + "transform", It = J("transformOrigin"), Xt = null !== J("perspective"), Nt = W.Transform = function() {
            this.perspective = parseFloat(a.defaultTransformPerspective) || 0,
            this.force3D = !(!1 === a.defaultForce3D || !Xt) && (a.defaultForce3D || "auto")
        }
        , Lt = _gsScope.SVGElement, Bt = function(t, e, i) {
            var s, r = j.createElementNS("http://www.w3.org/2000/svg", t), n = /([a-z])([A-Z])/g;
            for (s in i)
                r.setAttributeNS(null, s.replace(n, "$1-$2").toLowerCase(), i[s]);
            return e.appendChild(r),
            r
        }, Yt = j.documentElement || {}, jt = (Mt = d || /Android/i.test(G) && !_gsScope.chrome,
        j.createElementNS && !Mt && (At = Bt("svg", Yt),
        Dt = (Ct = Bt("rect", At, {
            width: 100,
            height: 50,
            x: 100
        ...
        Yt.removeChild(At)),
        Mt), Ut = function(t, e, i, s, r, n) {
            var o, l, h, _, u, f, c, p, d, m, g, y, v, T, x = t._gsTransform, b = Gt(t, !0);
            x && (v = x.xOrigin,
            T = x.yOrigin),
            ...
            m = b[4],
            g = b[5],
            (y = f * d - c * p) && (l = _ * (d / y) + u * (-p / y) + (p * g - d * m) / y,
            ...
            i.yOffset = x.yOffset,
            x = i),
            r || !1 !== r && !1 !== a.defaultSmoothOrigin ? (l = _ - v,
            h = u - T,
            x.xOffset += l * b[0] + h * b[2] - l,
            x.yOffset += l * b[1] + h * b[3] - h) : x.xOffset = x.yOffset = 0),
            n || t.setAttribute("data-svg-origin", o.join(" "))
        }, Vt = function(t) {
            var e, i = U("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), s = this.parentNode, r = this.nextSibling, n = this.style.cssText;
            if (Yt.appendChild(i),
            i.appendChild(this),
        ...
        }, Wt = [1, 0, 0, 1, 0, 0], Gt = function(t, e) {
            var i, s, r, n, a, o, l = t._gsTransform || new Nt, h = t.style;
            if (zt ? s = et(t, Et, null, !0) : t.currentStyle && (s = (s = t.currentStyle.filter.match(z)) && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), l.x || 0, l.y || 0].join(",") : ""),
            i = !s || "none" === s || "matrix(1, 0, 0, 1, 0, 0)" === s,
            !zt || !(o = !tt(t) || "none" === tt(t).display) && t.parentNode || (o && (n = h.display,
            h.display = "block"),
            t.parentNode || (a = 1,
            Yt.appendChild(t)),
            ...
            a && Yt.removeChild(t)),
            (l.svg || t.getCTM && qt(t)) && (i && -1 !== (h[zt] + "").indexOf("matrix") && (s = h[zt],
            i = 0),
            ...
            Pt = r.length; --Pt > -1; )
                n = Number(r[Pt]),
                r[Pt] = (a = n - (n |= 0)) ? (1e5 * a + (0 > a ? -.5 : .5) | 0) / 1e5 + n : n;
            return e && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r
        }, Zt = W.getTransform = function(t, i, s, r) {
            if (t._gsTransform && s && !r)
                return t._gsTransform;
            var n, o, l, h, _, u, f = s && t._gsTransform || new Nt, c = f.scaleX < 0, p = Xt && (parseFloat(et(t, It, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin) || 0, d = parseFloat(a.defaultTransformPerspective) || 0;
            if (f.svg = !(!t.getCTM || !qt(t)),
            f.svg && (Ut(t, et(t, It, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")),
            Rt = a.useSVGTransformAttr || jt),
            (n = Gt(t)) !== Wt) {
                if (16 === n.length) {
                    var m, g, y, v, T, x = n[0], b = n[1], w = n[2], P = n[3], O = n[4], S = n[5], k = n[6], R = n[7], A = n[8], C = n[9], D = n[10], M = n[12], F = n[13], z = n[14], E = n[11], I = Math.atan2(k, D);
                    f.zOrigin && (M = A * (z = -f.zOrigin) - n[12],
                    F = C * z - n[13],
                    z = D * z + f.zOrigin - n[14]),
                    f.rotationX = I * L,
                    I && (m = O * (v = Math.cos(-I)) + A * (T = Math.sin(-I)),
                    g = S * v + C * T,
                    y = k * v + D * T,
                    A = O * -T + A * v,
                    C = S * -T + C * v,
                    ...
                    I = Math.atan2(-w, D),
                    f.rotationY = I * L,
                    I && (g = b * (v = Math.cos(-I)) - C * (T = Math.sin(-I)),
                    y = w * v - D * T,
                    C = b * T + C * v,
                    D = w * T + D * v,
                    E = P * T + E * v,
                    ...
                    I = Math.atan2(b, x),
                    f.rotation = I * L,
                    I && (m = x * (v = Math.cos(I)) + b * (T = Math.sin(I)),
                    g = O * v + S * T,
                    y = A * v + C * T,
                    b = b * v - x * T,
                    S = S * v - O * T,
                    ...
                    b /= f.scaleX,
                    S /= f.scaleY,
                    Math.abs(I) > 2e-5 ? (f.skewX = I * L,
                    O = 0,
                    "simple" !== f.skewType && (f.scaleY *= 1 / Math.cos(I))) : f.skewX = 0,
                    f.perspective = E ? 1 / (0 > E ? -E : E) : 0,
                    f.x = M,
                    f.y = F,
                    f.z = z,
                    f.svg && (f.x -= f.xOrigin - (f.xOrigin * x - f.yOrigin * O),
                    ...
                    f.rotation = _,
                    f.skewX = u,
                    Xt && (f.rotationX = f.rotationY = f.z = 0,
                    f.perspective = d,
                    f.scaleZ = 1),
            ...
            f.svg && (Rt && t.style[zt] ? e.delayedCall(.001, function() {
                Kt(t.style, zt)
        ...
        , Ht = function(t) {
            var e, i, s = this.data, r = -s.rotation * N, n = r + s.skewX * N, a = 1e5, o = (Math.cos(r) * s.scaleX * a | 0) / a, l = (Math.sin(r) * s.scaleX * a | 0) / a, h = (Math.sin(n) * -s.scaleY * a | 0) / a, _ = (Math.cos(n) * s.scaleY * a | 0) / a, u = this.t.style, f = this.t.currentStyle;
            if (f) {
                i = l,
                l = -h,
                h = -i,
                ...
                if (null != s.ox && (T += (c = (s.oxp ? m * s.ox * .01 : s.ox) - m / 2) - (c * o + (p = (s.oyp ? g * s.oy * .01 : s.oy) - g / 2) * l),
                x += p - (c * h + p * _)),
                y ? v += ", Dx=" + ((c = m / 2) - (c * o + (p = g / 2) * l) + T) + ", Dy=" + (p - (c * h + p * _) + x) + ")" : v += ", sizingMethod='auto expand')",
                -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? u.filter = e.replace(E, v) : u.filter = v + " " + e,
                (0 === t || 1 === t) && 1 === o && 0 === l && 0 === h && 1 === _ && (y && -1 === v.indexOf("Dx=0, Dy=0") || O.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && u.removeAttribute("filter")),
                !y) {
                    var b, w, S, k = 8 > d ? 1 : -1;
                    for (c = s.ieOffsetX || 0,
                    p = s.ieOffsetY || 0,
                    ...
                    Pt = 0; 4 > Pt; Pt++)
                        w = ot[Pt],
                        b = f[w],
                        i = -1 !== b.indexOf("px") ? parseFloat(b) : it(this.t, w, parseFloat(b), b.replace(P, "")) || 0,
                        S = i !== s[w] ? 2 > Pt ? -s.ieOffsetX : -s.ieOffsetY : 2 > Pt ? c - s.ieOffsetX : p - s.ieOffsetY,
                        u[w] = (s[w] = Math.round(i - S * (0 === Pt || 2 === Pt ? 1 : k))) + "px"
                }
            }
        }, $t = W.set3DTransformRatio = W.setTransformRatio = function(t) {
            var e, i, s, r, n, a, o, l, h, _, u, f, p, d, m, g, y, v, T, x, b, w, P, O = this.data, S = this.t.style, k = O.rotation, R = O.rotationX, A = O.rotationY, C = O.scaleX, D = O.scaleY, M = O.scaleZ, F = O.x, z = O.y, E = O.z, I = O.svg, X = O.perspective, L = O.force3D, B = O.skewY, Y = O.skewX;
            if (B && (Y += B,
            k += B),
            !((1 !== t && 0 !== t || "auto" !== L || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && L || E || X || A || R || 1 !== M) || Rt && I || !Xt)
                ...
                i *= e = Math.sqrt(1 + e * e),
                n *= e)),
                I && (F += O.xOrigin - (O.xOrigin * i + O.yOrigin * s) + O.xOffset,
                z += O.yOrigin - (O.xOrigin * n + O.yOrigin * a) + O.yOffset,
                Rt && (O.xPercent || O.yPercent) && (m = this.t.getBBox(),
                F += .01 * O.xPercent * m.width,
                z += .01 * O.yPercent * m.height),
                (m = 1e-6) > F && F > -m && (F = 0),
                m > z && z > -m && (z = 0)),
                T = (i * P | 0) / P + "," + (n * P | 0) / P + "," + (s * P | 0) / P + "," + (a * P | 0) / P + "," + F + "," + z + ")",
                I && Rt ? this.t.setAttribute("transform", "matrix(" + T) : S[zt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + T) : S[zt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) matrix(" : "matrix(") + C + ",0,0," + D + "," + F + "," + z + ")";
            else {
                if (c && ((m = 1e-4) > C && C > -m && (C = M = 2e-5),
                m > D && D > -m && (D = M = 2e-5),
                ...
                k || Y)
                    ...
                    g = Math.cos(k),
                    y = Math.sin(k),
                    "simple" === O.skewType && (e = Math.tan((Y - B) * N),
                    e = Math.sqrt(1 + e * e),
                    g *= e,
                    y *= e,
                    ...
                    if (!(A || R || 1 !== M || X || I))
                        return void (S[zt] = (O.xPercent || O.yPercent ? "translate(" + O.xPercent + "%," + O.yPercent + "%) translate3d(" : "translate3d(") + F + "px," + z + "px," + E + "px)" + (1 !== C || 1 !== D ? " scale(" + C + "," + D + ")" : ""));
                    i = a = 1,
                    s = n = 0
                }
                _ = 1,
                ...
                i *= g,
                n *= g),
                (k = R * N) && (e = s * (g = Math.cos(k)) + r * (y = Math.sin(k)),
                v = a * g + o * y,
                h = _ * y,
                f = p * y,
                r = s * -y + r * g,
                ...
                R || A || 1 !== M ? (T += x + (m > h && h > -m ? b : h) + x + (m > f && f > -m ? b : f) + x + (m > r && r > -m ? b : r),
        ...
        St("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(t, e, i, s, n, o, l) {
                ...
                l[i] = e),
                _ && (l.scale = _(g, t));
                var u, f, c, p, d, y, v, T, x, b = t._gsTransform, w = t.style, P = Ft.length, O = l, S = {}, k = "transformOrigin", R = Zt(t, r, !0, O.parseTransform), A = O.transform && ("function" == typeof O.transform ? O.transform(g, m) : O.transform);
                if (R.skewType = O.skewType || R.skewType || a.defaultSkewType,
                s._transform = R,
                A && "string" == typeof A && zt)
                    ...
                    u.xPercent = ut(O.x, R.xPercent)),
                    "string" == typeof O.y && -1 !== O.y.indexOf("%") && (u.y = 0,
                    u.yPercent = ut(O.y, R.yPercent)),
                    u.rotation = ft("rotation"in O ? O.rotation : "shortRotation"in O ? O.shortRotation + "_short" : "rotationZ"in O ? O.rotationZ : R.rotation, R.rotation, "rotation", S),
                    Xt && (u.rotationX = ft("rotationX"in O ? O.rotationX : "shortRotationX"in O ? O.shortRotationX + "_short" : R.rotationX || 0, R.rotationX, "rotationX", S),
                    u.rotationY = ft("rotationY"in O ? O.rotationY : "shortRotationY"in O ? O.shortRotationY + "_short" : R.rotationY || 0, R.rotationY, "rotationY", S)),
                    u.skewX = ft(O.skewX, R.skewX),
                    u.skewY = ft(O.skewY, R.skewY)
                }
                for (Xt && null != O.force3D && (R.force3D = O.force3D,
                p = !0),
                (c = R.force3D || R.z || R.rotationX || R.rotationY || u.z || u.rotationX || u.rotationY || u.perspective) || null == O.scale || (u.scaleZ = 1); --P > -1; )
                    x = Ft[P],
                    A = u[x] - R[x],
                    (A > 1e-6 || -1e-6 > A || null != O[x] || null != B[x]) && (p = !0,
                ...
                R.svg && (A || O.svgOrigin) && (y = R.xOffset,
                v = R.yOffset,
                Ut(t, ht(A), u, O.svgOrigin, O.smoothOrigin),
                n = bt(R, "xOrigin", (b ? R : u).xOrigin, u.xOrigin, n, k),
                n = bt(R, "yOrigin", (b ? R : u).yOrigin, u.yOrigin, n, k),
                (y !== R.xOffset || v !== R.yOffset) && (n = bt(R, "xOffset", b ? y : R.xOffset, R.xOffset, n, k),
                n = bt(R, "yOffset", b ? v : R.yOffset, R.yOffset, n, k)),
                A = "0px 0px"),
                (A || Xt && c && R.zOrigin) && (zt ? (p = !0,
                x = It,
                ...
                Xt ? (f = R.zOrigin,
                A = A.split(" "),
                R.zOrigin = (A.length > 2 && (0 === f || "0px" !== A[2]) ? parseFloat(A[2]) : f) || 0,
                n.xs0 = n.e = A[0] + " " + (A[1] || "50%") + " 0px",
                (n = new xt(R,"zOrigin",0,0,n,-1,n.n)).b = f,
                n.xs0 = n.e = R.zOrigin) : n.xs0 = n.e = A) : ht(A + "", R)),
                p && (s._transformType = R.svg && Rt || !c && 3 !== this._transformType ? 2 : 3),
                h && (l[i] = h),
                _ && (l.scale = _),
                n
            },
        ...
        St("borderRadius", {
            ...
            parser: function(t, e, i, n, a, o) {
                ...
                h = 0; h < P.length; h++)
                    ...
                    y = c.substr((d + "").length)),
                    "" === y && (y = s[i] || v),
                    y !== v && (x = it(t, "borderLeft", p, v),
                    b = it(t, "borderTop", p, v),
                    "%" === y ? (f = x / m * 100 + "%",
                    u = b / g * 100 + "%") : "em" === y ? (w = it(t, "borderLeft", 1, "em"),
                    f = x / w + "em",
                    u = b / w + "em") : (f = x + "px",
                    u = b + "px"),
        ...
        St("backgroundPosition", {
            defaultValue: "0 0",
            parser: function(t, e, i, s, n, a) {
                var o, l, h, _, u, f, c = "background-position", p = r || tt(t, null), m = this.format((p ? d ? p.getPropertyValue(c + "-x") + " " + p.getPropertyValue(c + "-y") : p.getPropertyValue(c) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), g = this.format(e);
                if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && ((f = et(t, "backgroundImage").replace(D, "")) && "none" !== f)) {
                    ...
                    h = 2; --h > -1; )
                        m = o[h],
                        _ = -1 !== m.indexOf("%"),
                        _ !== (-1 !== l[h].indexOf("%")) && (u = 0 === h ? t.offsetWidth - q.width : t.offsetHeight - q.height,
        ...
        St("clip", {
            ...
            parser: function(t, e, i, s, n, a) {
                ...
                e = this.format(e).split(",").join(h)) : (o = this.format(et(t, this.p, r, !1, this.dflt)),
                e = this.format(e)),
        ...
        St("border", {
            ...
            parser: function(t, e, i, s, n, a) {
                ...
                this.parseComplex(t.style, this.format(o + " " + et(t, "borderTopStyle", r, !1, "solid") + " " + et(t, "borderTopColor", r, !1, "#000")), l.join(" "), n, a)
            },
            color: !0,
            formatter: function(t) {
                var e = t.split(" ");
        ...
        var Qt = function(t) {
            ...
            e = !et(this.data, "filter")) : (i.filter = s.replace(k, ""),
            e = !0)),
            e || (this.xn1 && (i.filter = s = s || "alpha(opacity=" + r + ")"),
            -1 === s.indexOf("pacity") ? 0 === r && this.xn1 || (i.filter = s + " alpha(opacity=" + r + ")") : i.filter = s.replace(O, "opacity=" + r))
        };
        St("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, i, s, n, a) {
                ...
                Z ? n = new xt(l,"opacity",o,e - o,n) : ((n = new xt(l,"opacity",100 * o,100 * (e - o),n)).xn1 = h ? 1 : 0,
                l.zoom = 1,
                n.type = 2,
                ...
                n.plugin = a,
                n.setRatio = Qt),
                h && ((n = new xt(l,"visibility",0,0,n,-1,null,!1,0,0 !== o ? "inherit" : "hidden",0 === e ? "hidden" : "inherit")).xs0 = "inherit",
                s._overwriteProps.push(n.n),
        ...
        St("className", {
            parser: function(t, e, s, n, a, o, l) {
                ...
                if ((a = n._classNamePT = new xt(t,s,0,0,a,2)).setRatio = Jt,
                a.pr = -11,
                i = !0,
                a.b = p,
                _ = rt(t, r),
        ...
        var te = function(t) {
            if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                if ("all" === this.e)
                    ...
                    s = e.length; --s > -1; )
                        i = e[s],
                        l[i] && (l[i].parse === o ? r = !0 : i = "transformOrigin" === i ? It : l[i].p),
                        Kt(a, i);
                r && (Kt(a, zt),
        ...
        h._onInitTween = function(t, e, o, h) {
            ...
            if (u && "" === O.zIndex && (("auto" === (c = et(t, "zIndex", r)) || "" === c) && this._addLazySet(O, "zIndex", 0)),
            ...
            this._transformType) {
                ...
                p && this._addLazySet(O, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (P ? "visible" : "hidden"))) : O.zoom = 1,
                y = d; y && y._next; )
                    y = y._next;
        ...
        h.parse = function(t, e, i, n) {
            ...
            for (a in e) {
                if ("function" == typeof (c = e[a]) && (c = c(g, m)),
                o = l[a])
                    ...
                    f = et(t, a, r) + "",
                    y = "string" == typeof c,
                    "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || y && R.test(c) ? (y || (c = ((c = dt(c)).length > 3 ? "rgba(" : "rgb(") + c.join(",") + ")"),
                    i = wt(T, a, f, c, !0, "transparent", i, 0, n)) : y && X.test(c) ? i = wt(T, a, f, c, !0, null, i, 0, n) : (p = (h = parseFloat(f)) || 0 === h ? f.substr((h + "").length) : "",
                    ("" === f || "auto" === f) && ("width" === a || "height" === a ? (h = lt(t, a, r),
                    p = "px") : "left" === a || "top" === a ? (h = st(t, a, r),
                    p = "px") : (h = "opacity" !== a ? 0 : 1,
                    p = "")),
                    (v = y && "=" === c.charAt(1)) ? (u = parseInt(c.charAt(0) + "1", 10),
                    c = c.substr(2),
                    u *= parseFloat(c),
                    d = c.replace(P, "")) : (u = parseFloat(c),
                    d = y ? c.replace(P, "") : ""),
                    "" === d && (d = a in s ? s[a] : p),
                    c = u || 0 === u ? (v ? u + h : u) + d : e[a],
                    p !== d && ("" !== d || "lineHeight" === a) && (u || 0 === u) && h && (h = it(t, a, h, p),
                    "%" === d ? (h /= it(t, a, 100, "%") / 100,
                    !0 !== e.strictUnits && (f = h + "%")) : "em" === d || "rem" === d || "vw" === d || "vh" === d ? h /= it(t, a, 1, d) : "px" !== d && (u = it(t, a, u, d),
                    d = "px"),
                    v && (u || 0 === u) && (c = u + h + d)),
                    v && (u += h),
                    !h && 0 !== h || !u && 0 !== u ? void 0 !== T[a] && (c || c + "" != "NaN" && null != c) ? (i = new xt(T,a,u || h || 0,0,i,-1,a,!1,0,f,c)).xs0 = "none" !== c || "display" !== a && -1 === a.indexOf("Style") ? c : f : $("invalid " + a + " tween value: " + e[a]) : (i = new xt(T,a,h,u - h,i,0,a,!1 !== _ && ("px" === d || "zIndex" === a),0,f,c)).xs0 = d)
                }
    ...
    (e = _gsScope._gsDefine.plugin({
        ...
        for (var e, i, s, r = this._tween, n = r.vars.roundProps.join ? r.vars.roundProps : r.vars.roundProps.split(","), a = n.length, o = {}, l = r._propLookup.roundProps; --a > -1; )
            o[n[a]] = Math.round;
        for (a = n.length; --a > -1; )
            for (e = n[a],
            i = r._firstPT; i; )
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(t) {
        ...
        (m = (i = l("easing.RoughEase", function(e) {
            for (var i, s, r, n, a, o, l = (e = e || {}).taper || "none", h = [], _ = 0, u = 0 | (e.points || 20), c = u, p = !1 !== e.randomize, d = !0 === e.clamp, m = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --c > -1; )
...
function(t, e) {
    "use strict";
    var i, s, r = {}, n = t.document, a = t.GreenSockGlobals = t.GreenSockGlobals || t;
    if (!a.TweenLite) {
        var o, l, h, _, u, f = function(t) {
            ...
            for (e = 0; e < i.length; e++)
                s[i[e]] = s = s[i[e]] || {};
            return s
        }, c = f("com.greensock"), p = 1e-10, d = function(t) {
            var e, i = [], s = t.length;
            for (e = 0; e !== s; i.push(t[e++]))
                ;
            return i
        }, m = function() {}, g = (i = Object.prototype.toString,
        s = i.call([]),
        function(t) {
            return null != t && (t instanceof Array || "object" == typeof t && !!t.push && i.call(t) === s)
        }
        ), y = {}, v = function(i, s, n, o) {
            this.sc = y[i] ? y[i].sc : [],
            y[i] = this,
            this.gsClass = null,
            this.func = n;
            ...
            this.check = function(h) {
                for (var _, u, c, p, d = s.length, m = d; --d > -1; )
                    (_ = y[s[d]] || new v(s[d],[])).gsClass ? (l[d] = _.gsClass,
                    m--) : h && _.sc.push(this);
                if (0 === m && n) {
                    if (c = (u = ("com.greensock." + i).split(".")).pop(),
        ...
        var b = [0, 0, 1, 1]
          ...
          , O = w.register = function(t, e, i, s) {
            for (var r, n, a, o, l = e.split(","), h = l.length, _ = (i || "easeIn,easeOut,easeInOut").split(","); --h > -1; )
                ...
                a = _.length; --a > -1; )
                    o = _[a],
                    P[n + "." + o] = P[o + n] = r[o] = t.getRatio ? t : t[o] || new t
        }
        ;
        ...
        l = (o = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; --l > -1; )
            ...
            O(new w(null,null,2,l), h, "easeIn" + (0 === l ? ",easeNone" : "")),
        ...
        x("Ticker", function(t, e) {
            var i, s, r, a, o, l = this, h = A(), f = !(!1 === e || !k) && "auto", c = 500, p = 33, d = function(t) {
                var e, n, _ = A() - C;
                _ > c && (h += _ - p),
                C += _,
                l.time = (C - h) / 1e3,
            ...
            l.lagSmoothing = function(t, e) {
                return arguments.length ? (c = t || 1e10,
                void (p = Math.min(e, c, 0))) : 1e10 > c
            }
            ,
            l.sleep = function() {
                null != r && (f && R ? R(r) : clearTimeout(r),
                s = m,
                r = null,
                l === _ && (u = !1))
            }
            ,
            l.wake = function(t) {
                null !== r ? l.sleep() : t ? h += -C + (C = A()) : l.frame > 10 && (C = A() - c + 5),
        ...
        h.paused = function(t) {
            ...
            return t != this._paused && s && (u || t || _.wake(),
        ...
        var z = x("TweenLite", function(e, i, s) {
            ...
            if (this._overwrite = l = null == l ? Z[z.defaultOverwrite] : "number" == typeof l ? l >> 0 : Z[l],
            (o || e instanceof Array || e.push && g(e)) && "number" != typeof e[0])
                for (this._targets = a = d(e),
                this._propLookup = [],
                this._siblings = [],
                r = 0; r < a.length; r++)
                    n = a[r],
                    n ? "string" != typeof n ? n.length && n !== t && n[0] && (n[0] === t || n[0].nodeType && n[0].style && !n.nodeType) ? (a.splice(r--, 1),
                    this._targets = a = a.concat(d(n))) : (this._siblings[r] = J(n, this, !1),
                    1 === l && this._siblings[r].length > 1 && et(n, this, null, 1, this._siblings[r])) : (n = a[r--] = z.selector(n),
        ...
        var I = []
          ...
          , K = U.lazyRender = function() {
            ...
            for (X = {}; --e > -1; )
                t = I[e],
                t && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0),
                t._lazy = !1);
            I.length = 0
        }
        ;
        ...
        var J = function(t, e, i) {
          ...
          , et = function(t, e, i, s, r) {
            ...
            for (n = r.length; --n > -1; )
                (o = r[n]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || it(e, 0, c),
        ...
        h._init = function() {
            ...
            if (this._ease = _ = _ ? _ instanceof w ? _ : "function" == typeof _ ? new w(_,a.easeParams) : P[_] || z.defaultEase : z.defaultEase,
        ...
        h._initProps = function(e, i, s, r, n) {
            ...
            if (null == e)
                return !1;
            X[e._gsTweenID] && K(),
            this.vars.css || e.style && e !== t && e.nodeType && V.css && !1 !== this.vars.autoCSS && function(t, e) {
                var i, s = {};
                for (i in t)
            ...
            for (a in this.vars)
                if (u = this.vars[a],
                G[a])
                    u && (u instanceof Array || u.push && g(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[a] = u = this._swapSelfInParams(u, this));
        ...
        z.getTweensOf = function(t, e) {
            if (null == t)
                return [];
            var i, s, r, n;
            if (t = "string" != typeof t ? t : z.selector(t) || t,
...
!function(t, n) {
    ...
    var t, n, e, r, a, o = {
        ...
        update: void 0,
        complete: void 0
    }, u = "translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY".split(" "), i = {
        arr: function(t) {
    ...
    r), c = function(t) {
        ...
        return i.arr(t) ? t : (i.str(t) && (t = l(t) || t),
        ...
        }(n) : void 0 : y(n) ? n : (!(t = y(t.to) ? y(t.to) : y(t.from)) && e && (t = y(e)),
        t ? n + t : n)
    }, k = function(t) {
        var n = /-?\d*\.?\d+/g;
        return {
        ...
        return "transform" === e ? (e = t + "(" + b(t, n.from, n.to) + ")",
        n = t + "(" + b(t, n.to) + ")") : (t = "css" === e ? x(r, t) : void 0,
        e = O(n, n.from, t),
        n = O(n, n.to, t)),
        {
            from: k(e),
        ...
        (e = t).forEach(function(t, n) {
            ...
            return r.forEach(function(r) {
                ...
                if (u) {
                    ...
                    c.delay = (i.fnc(c.delay) ? c.delay(o, n, e.length) : c.delay) / N.speed,
                    c.duration = (i.fnc(c.duration) ? c.duration(o, n, e.length) : c.duration) / N.speed,
                    a.push(c)
                }
            })
        }),
        ...
        return t.tweens.forEach(function(t) {
            "css" !== t.type && "transform" !== t.type || (n.push("css" === t.type ? f(t.name) : "transform"),
        ...
        var e, r, a, o = Math.min(Math.max(n - t.delay, 0), t.duration) / t.duration, u = t.to.numbers.map(function(n, e) {
        ...
        if (r)
            for (a in t || (t = (x(document.body, "transform") ? "" : "-webkit-") + "transform"),
            r)
    ...
    n), N = function(t) {
        ...
        return n.tick = function(t) {
            ...
            C(n, e.current);
            var r = n.settings;
            r.begin && e.current >= r.delay && (r.begin(n),
            r.begin = void 0),
            e.current >= n.duration && (r.loop ? (e.start = t,
            "alternate" === r.direction && A(n, !0),
            i.num(r.loop) && r.loop--) : (n.ended = !0,
            n.pause(),
        ...
        var h = i(1)
          ...
          , u = function() {
            ...
            return t.prototype.listenToDOM = function() {
                a && (window.addEventListener ? (this.item === document.body ? window.addEventListener("scroll", this.DOMListener) : this.item.addEventListener("scroll", this.DOMListener),
...
!function(e) {
    ...
    n.prototype._layout = function() {
        ...
        "fixed" !== e && "absolute" !== e && "relative" !== e && (this.el.style.position = "relative"),
    ...
    n.prototype.reveal = function(e) {
        ...
        var f = e.coverArea || a;
        "lr" === s || "rl" === s ? (v.scaleX = [0, 1],
        h.scaleX = [1, f / 100]) : (v.scaleY = [0, 1],
        h.scaleY = [1, f / 100]),
