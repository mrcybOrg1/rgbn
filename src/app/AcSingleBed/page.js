...
const AcSingleBed = () => {
    const imgs=[
        {id:0,value: IMAGES.room5},
        {id:1,value: IMAGES.room6},
        {id:2,value: IMAGES.room7},
        {id:3,value: IMAGES.room1},
        {id:4,value: IMAGES.room2},
        {id:5,value: IMAGES.room3},
        {id:6,value: IMAGES.room4},
        {id:7,value: IMAGES.room8},
        {id:8,value: IMAGES.room10},
        {id:9,value: IMAGES.room15},
        {id:10,value: IMAGES.room16},
    ];
  ...
  return (
    ...
    <div className='flex_row'>
      ...
      <img src={sliderData.value} height="500" width="800" />
    </div>
    </div>
    ...
    <div className="section z-bigger">		
            ...
            <h1 className='text-center padding-bottom-small'>Ac Single Bed</h1>
							<h5>discription</h5>
							<p className="mt-3">we provide tise room with ac</p>
						</div>
						<div className="section pt-4">
							<div className="row">
								...
								<div className="col-lg-6">
									...
									<p><strong className="color-black">Occupancy:</strong> Up to 2 adulds</p>	
									<p><strong className="color-black">View:</strong> Temple view</p>	
